...
struct CudaTypeTraits<float> {
    ...
    static constexpr cudnnDataType_t cudnn_data_type = CUDNN_DATA_FLOAT;
    static constexpr cudnnDataType_t cudnn_compute_type = CUDNN_DATA_FLOAT;
...
struct CudaTypeTraits<double> {
    ...
    static constexpr cudnnDataType_t cudnn_data_type = CUDNN_DATA_DOUBLE;
    static constexpr cudnnDataType_t cudnn_compute_type = CUDNN_DATA_DOUBLE;
...
struct CudaTypeTraits<__half> {
    ...
    static constexpr cudnnDataType_t cudnn_data_type = CUDNN_DATA_HALF;
    static constexpr cudnnDataType_t cudnn_compute_type = CUDNN_DATA_FLOAT;
...
struct CudaTypeTraits<__nv_bfloat16> {
    ...
    static constexpr cudnnDataType_t cudnn_data_type = CUDNN_DATA_BFLOAT16;
    static constexpr cudnnDataType_t cudnn_compute_type = CUDNN_DATA_FLOAT;
